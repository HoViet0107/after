...
public class UserServiceImpl implements UserService {
     ...
     * @param jwtTokenProvider Utility for JWT token generation and validation
     * @param roleRepos Repository for user roles
     */
    @Autowired
    public UserServiceImpl(PasswordEncoder passwordEncoder, UserRepository userRepo, JwtTokenProvider jwtTokenProvider, RolesRepository roleRepos) {
    ...
    public AuthResponse login(AuthDTO userDTO) {
        ...
        // generate token
        String token = jwtTokenProvider.generateToken(userDTO.getEmail(), roleNames);
