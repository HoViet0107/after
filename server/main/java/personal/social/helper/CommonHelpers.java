...
public class CommonHelpers {
    ...
    @Autowired
    public CommonHelpers(JwtTokenProvider jwtTokenProvider, UserRepository userRepos) {
    ...
    public Users extractToken(HttpServletRequest request) {
        ...
        Users existedUser = userRepos.findByEmail(jwtTokenProvider.extractEmail(token));
        if (existedUser == null) {
