...
public class PostController {
     ...
     * @param request      The comment request containing content and optional parent comment ID
     * @param httpRequest  The HTTP request object used to extract the authenticated user
     * @return             ResponseEntity containing the created comment with HTTP 201 status
     * @apiNote           Rate limited to 30 requests per 60 seconds per user
     */
