...
public class Users extends AggregateRoot<UserId> {
     ...
     * Create new user
     */
    public static Users create(UserId id, Email email, UserProfile profile, String passwordHash, String phoneNumber) {
     ...
     */
    public static Users createWithAutoId(Email email, UserProfile profile, String passwordHash, String phoneNumber) {
        return create(UserId.generate(), email, profile, passwordHash, phoneNumber);
    }

    /**
     * Create basic user profile
     */
    public static Users createBasicUser(Email email, String firstName, String lastName, LocalDateTime dob, String passwordHash, String phoneNumber, String gender) {
        UserProfile profile = new UserProfile(firstName, null, lastName, null, dob, gender, null);
        return createWithAutoId(email, profile, passwordHash, phoneNumber);
    }
