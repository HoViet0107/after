...
import personal.social.comment.application.dto.CreateReplyRequest;
...
public class CommentApplicationService {
    ...
    public CommentDto createReply(CreateReplyRequest request){
        PostComment comment = PostComment.builder()
                .postId(PostId.of(request.postId()))
                .authorId(UserId.of(request.authorId()))
                .content(CommentContent.of(request.content()))
        ...
        PostComment savedReply = commentRepository.save(comment);

        // Publish events
        eventPublisher.publishEvents(savedReply.getDomainEvents());
        savedReply.clearDomainEvents();
